...
\label{sec:FirstRollSpeedRestrictions}
    ...
    Each semester all drivers must be bagged on their first roll in each buggy that
    they drive. Each semester new drivers must also be bagged for their first three rolls
    in each buggy that they drive, unless they have reached their maximum fall roll
    carryover amount. The first roll after being involved in an accident (as per
    rule \ref{sec:Accidents}) for all drivers during Freeroll practices must also
    be bagged, as well as any time the Safety Chairman deems it necessary for the
    safety of the buggy's driver.
