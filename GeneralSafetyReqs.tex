...
\subsection{Spot Safety Checks}
	...
	\begin{itemize}
		...
		\item A check that at least one follow car certified individual was inside any 
		active follow car on the course.
...
\section{Follow Car Certification}
	...
	to explain the correct procedures during an emergency situation. The Follow Car 
	Certification Program shall consist of the following: 
