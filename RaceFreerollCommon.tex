\chapter{Race and Freeroll Common Rules and Procedures}

\section{General Procedures and Rules}
	Freeroll events shall be known as the combination of freeroll practices and 
	Sweepstakes races. Push Practices shall be governed by the following only 
	where specifically mentioned. Freeroll events shall always be governed 
	by the following:
