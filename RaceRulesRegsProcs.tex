...
\subsection{Electrical Power}
	...
	provided by the Physical Plant Department of Carnegie Mellon University or through the Spring Carnival Committee (SCC). Arrangements to provide this power should be made with the Physical Plant Department by the Sweepstakes Chairman, through the office of the Sweepstakes Advisor, at least six weeks before the races are scheduled to take place; or with the SCC Head of Electrical. 
...
\label{subsec:Course Watch}
	...
	participating organization must provide two people to watch the course. The length of time that each person must watch the course and the area that they must watch shall be determined by the Sweepstakes Chairman.

	Any organization that fails to provide the required number of people for course watch duty on the night before any day of Sweepstakes
	racing, shall be fined the amount of \$25.00 for each missing person.
...
\subsubsection{Course Judges}
	...
	Course judges will be members of the Carnegie Mellon University
