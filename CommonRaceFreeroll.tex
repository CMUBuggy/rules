...
\subsection{Hay Bales}
	...
	Approximately 160 fall and an additional 160 spring hay bales should be 
	obtained for use during freeroll practice, with one layer lining both sides 
	of the chute. An additional 140 hay bales should be obtained for Raceday, when 
	two layers must line both sides of the chute. Bales of hay, as opposed to bales 
	of straw, are usually used because they tend to hold up better and therefore 
	can be used more times before they start to fall apart. Freeroll events shall 
	only be held when an adequate number of hay bales are in place around the buggy 
	course. The Safety Chairman, or anyone designated by that Chairman, shall 
	determine how many hay bales are required in order to have a freeroll event, 
	and where around the buggy course those hay bales shall be placed, in order to 
	provide the maximum amount of protection to the freeroll event participants.
