...
\subsection{Braking Capability Test}
	...
	The test shall take place on a flat, level, and smooth area, that is paved with either concrete or asphalt.If the area chosen is not completely level, the test shall be run in a direction such that the buggy being tested shall be moving toward the lower end of the area during the test. The sidewalk starting at Purnell and moving towards the University Center shall be used if it is available and in acceptable condition. If this area is not available or acceptable the Safety Chairman, or anyone designated by that Chairman, shall use the alternate location for the test. The alternate location for the test is the sidewalk directly beneath Purnell. An additional 2 individuals are required to help complete the braking capability test and will be stationed at either end of the sidewalk to prevent crowds from entering the testing location. A buggy may be tested for rearward braking at any time by the safety chairman as part of a spot safety check.
	...
	\begin{itemize}
		...
		\item
		The buggy must pass through the 50 foot timing zone within 2.25 seconds.

		\item
		The buggy must then stop within 30 ft (measured to the nose).
...
The test shall take place on Tech Street, along Hill 1 of the buggy course. The start line shall be marked on the eastern side of Tech Street according to the placement of the Sweepstakes plaque in the sidewalk. The area will be used if it is available and is in acceptable condition. If this area is not available or acceptable, the Safety Chairman, or anyone designated by that Chairman, shall choose an alternate location for the test along Tech Street or the sidewalks directly parallel to Tech Street.

The test shall be conducted as follows:
\begin{itemize}
	\item The buggy shall be placed at rest on the road facing toward the bottom of the hill, with its nose at the beginning of a marked 30 foot long zone.
...
\subsection{Eye Protection}
	...
	Drivers MUST wear approved goggles with anti fogging compounds or solutions applied whenever they are driving a buggy. The goggles must have shatterproof lenses, and must provide side-shield protection to the eyes. Any goggles that are examined by the Safety Chairman and are deemed to be adequate, or that meet the requirements of ANSI Z87.1, are considered to be approved goggles. Goggles with tinted lenses may only be used by buggy drivers when they are driving a buggy anytime before sunset and after sunrise, while goggles with clear lenses may be used by buggy drivers when they are driving a buggy anytime. A driver with visual acuity of less than 20/40 combined vision SHALL wear lenses correcting combined vision to 20/40 or greater at all times while driving a buggy. These corrective lenses shall either be contact lenses on the surface of the driver’s eyes, OR part of the goggles specified above, with the shatterproof lenses doubling as corrective lenses. Goggles may NOT be worn over eyeglasses.
...
\subsection{Head Protection}
	...
	In the event of a significant crash as determined by the safety chairman, the helmet used by the driver in the crash must be retired and the organization must use another approved helmet going forward.
...
\section{Field of Vision}
	...
	\begin{itemize}
		...
		\item
		The buggy shall be aligned in such a way that a 90 degree angle, whose origin is located at 10 inches in front of the nose along the centerline of the buggy and whose bisector is coincident with the centerline of the buggy, can be determined.
...
\section{Pushbar}
	...
	Each buggy shall have a structure which its pushers can push on, in order to propel that buggy forward. This structure shall be known as a pushbar. This pushbar shall NOT be considered to be a part of that buggy's protective cage. Each pushbar shall have a structurally sound cross-piece at its end, which shall be known as the pushbar handle. The pushbar handle will usually be perpendicular to the pushbar and, to ensure safety, should have the recommended, but not required, dimensions of 8 inches long by 1 inch in diameter. This pushbar shall be poistioned at least 1 foot away from the driver's protective cage.
...
\section{Wheels}
	...
	All fasteners and hardware (i.e. nuts, bolts, collars, etc.) that are used to secure a buggy's wheels to that buggy shall be equipped with locking devices such as lock nuts, lock washers, lock wires, cotter pins, etc. The use of anaerobic locking compounds (such as Loctite) is permissible,but is not sufficient. Alternatively, if a male threaded fastening system is used, either a locking device OR a reverse threaded fastener on the left-hand side of the buggy may satisfy the requirement. In this case, the male threaded fastener must have a minimum diameter of ¼ inch and must have thread engagement at least twice that of the fastener diameter. 
...
\subsection{Interior Debris Shield}
	...
	\begin{itemize}
		...
		\item
		This shield shall be made of clear polycarbonate plastic, which has a minimum nominal thickness of 0.062 inches, also trademarked LEXAN (R) General Electric. It shall be at least 4.0 inches wide 1 inch above the wheel.
