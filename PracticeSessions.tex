...
\subsection{Drivers}
	...
	\begin{itemize}
		...
		\item
		If a driver is new they must observe another driver's complete freeroll from the view of a follow car. A driver is considered new if they are unfamiliar with the course and have never attempted a freeroll. Drivers returning after any length of hiatus are not new under this definition. Drivers who are course knowledgeable (previous head mechs, chairs, …) may also be exempt at the discretion of the Sweepstakes Safety Chairperson.
