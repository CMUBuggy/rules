...
\subsection{Drop Tests and Safety Equipment Check}
	...
	Before each freeroll practice session starts each buggy, including all robotic buggies, is required to take a drop brake test as follows: 
...
\subsection{New Driver Follow Car Requirement}
\label{subsec:New Driver Follow Car}

    If a driver is new they must observe another driver's complete freeroll from the view of a follow car. A driver is considered new if they are unfamiliar with the course and have never attempted a freeroll. At the discretion of the Sweepstakes Safety Chairperson, drivers who are familiar with the course but have never attempted a freeroll may be exempt from this requirement.

    The new driver must sit in the shotgun seat of the follow car. They must be accompanied by a returning driver or similarly experienced individual, as approved by the Sweepstakes Safety Chairperson. The appointed individual must verbally describe the course and answer any questions the new driver may have. Upon completing the observation, the new driver must check in with the Sweepstakes Safety Chairperson who will mark them as eligible to roll upon confirming the observation requirements were met. Only one new driver may complete this requirement per ride in the follow car.
...
\subsection{Drivers}
	...
	\begin{itemize}
		...
		\item
        If a driver is new they must have previously completed the new driver follow car requirement as outlined in sec. \ref{subsec:New Driver Follow Car}
