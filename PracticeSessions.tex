...
\subsection{Accidents}
	...
	An accident shalled be considered any incident in which a collision occurs,
	or the buggy comes to an uncontrolled stop.

	Collisions may occur during freeroll practice sessions. If an collision does
	...
	If no medical personnel are immediatly available, the Safety Chairman
	...
	sponsoring buggy's organization will cooperate fully with the EMS and allow the
	medical staff access to the driver.  Generally, EMS personnel will seek to
	communicate briefly with the driver to determine the condition of that driver.
	If any member of that organization or one of their alumni hinders access to the
	driver by EMS personnel, that organization may be entirely disqualified from
	that year's races.
...
\subsection{Informational Flyers}
	...
	In addition, the campus community itself must be made aware of push
	practices. A post should be made to misc.market and a memo should be
	distributed to the faculty and staff so that they are knowledgeable concerning
	when and where push practices will be in progress.

\subsection{Official Notification}

	The sweepstakes chair shall notify the Carnegie Mellon University Campus
	...
	are questioned by campus or city police.
...
\subsection{Pushing Order}
	...
	hill they have not been assigned to unless they recieve permission from all
	the organizations assigned to that hill, or all the organizations assigned to
	that hill have left. 
